...
class PositionalList(_DoublyLinkedBase):
    ...
    def add_first(self, e):
        """Insert element e at the front of the list and return new
        Position."""
    ...
    def split_after_position(self, p):
        ...
        # Splits self list into two lists. After splitting, the self list
        # will include things up to and include p. return another valid
        # PositionalList that contains things after p.
        ...
        # To do
        newPosList = PositionalList()
        newPosList._header = self._validate(p)
        newPosList._trailer = self._trailer
        self._trailer = self._validate(self.after(p))
        return newPosList

def play():
    # task 1, play around Positional List class.
    # 1. start an instance of Positional List
    # 2. insert value 9999, make 9999 the first node, save the Position of 9999
    # in a variable.
    # 3. insert value 6666 after 9999, save the Position of 6666 in a variable.
    # 4. replace value 6666 with 66666.
    # 5. delete 9999.
    pos = PositionalList()
    posSecond = pos.add_first(9999)
    posFirst = pos.first()
    pos.add_after(posFirst, 6666)
    pos.delete(posFirst)
