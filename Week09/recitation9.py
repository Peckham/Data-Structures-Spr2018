...
class TreeMap(LinkedBinaryTree, MapBase):
    ...
    def min_key(self):
        ''' return the minimum key stored within the tree '''
        return str(self.find_min()[0])


    def second_min_key(self):
        ''' return the second smallest key stored within the tree '''
        if self.is_empty():
            return None
        else:
            p = self.first().before()
    ...
    def is_valid(self):
        '''Returns True if the self tree is a valid binary search tree. Returns false otherwise '''
        # Task 4
        pass
...
class AVLTreeMap(TreeMap):
    ...
    def generate_merged(self, other):
        ''' When called, return a new merged, balanced binary search tree.
            Self tree and other tree stay unmodified '''
        # Task 5
        pass
...
print(n.root().element()._key)

# -------------------------- Task 2 tests     --------------------------
print("-------------------------- Task 2 tests --------------------------")
print("Minimum of tree is: ", t.min_key())    # Should be 0


# -------------------------- Task 3 tests --------------------------
print("-------------------------- Task 3 tests     --------------------------")
print("Second smallest of tree is: ", t.second_min_key())    # Should be 1
...
#        / \   \
#        4 6   9
print("Is the tree a valid BST?: ", t.is_valid())  # Should be True for this tree


############# Mess up the tree ###################
three = MapBase._Item(3, "messed up value")
node_three = LinkedBinaryTree._Node(three, t.last(), None, None)
position_three = LinkedBinaryTree.Position(t, node_three)
t.last()._node._left = node_three
...
#                            /
#                            3
print("Is the tree a valid BST?: ", t.is_valid())  # Should be False for this tree
...
# t1.generate_merged(t2).pretty_print()         # Uncomment this
