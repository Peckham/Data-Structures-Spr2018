...
class ArrayQueue:
    ...
    def _resize(self, cap):                  # we assume cap >= len(self)
        ...
        self._data = [None] * cap
        walk = self._front
        for k in range(self._size):            # only consider existing elts
...
print("1. Current Contents of Queue: ", queue1)
print("\n")
...
print("2. Current Contents of Queue: ", queue1)
print("\n")
...
print("3. After Rotating, Current Contents of Queue: ", queue1)
print("\n")
